...
void initHighscoreTable(void) 
{
	...
	for (i = 0; i < NUM_HIGHSCORES; i++)
	{
		...
		strncpy_s(highscores.highscore[i].name, 16, "ANONYMOUS", MAX_SCORE_NAME_LENGTH);
	}
...
static void doNameInput(void)
{
	...
	if (app.keyboard[SDL_SCANCODE_RETURN])
	{
		...
		{
			strncpy_s(newHighscore->name, 16, "ANONYMOUS", MAX_SCORE_NAME_LENGTH);
		}
...
static void drawNameInput(void)
{
	...
	drawText(SCREEN_WIDTH / 2, 70, 255, 255, 255, TEXT_CENTER, "CONGRATULATIONS, YOU'VE HIT A NEW HIGHSCORE!");
